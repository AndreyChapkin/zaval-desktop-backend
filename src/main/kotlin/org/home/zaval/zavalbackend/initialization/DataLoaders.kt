...
//}
//
//fun loadTodos(): List<TodoFullDto> {
...
//}
//
//fun placeTodosInMainMemory(todos: List<TodoFullDto>, todoRepository: TodoRepository) {
//    val ROOT_ID_PLACEHOLDER = Long.MIN_VALUE
//    val parentChildrenIds: MutableMap<Long, MutableList<Long>> = mutableMapOf()
//    val idAndDtos: MutableMap<Long, TodoFullDto> = mutableMapOf()
//    todos.forEach {
//        idAndDtos[it.id] = it
